...
class FrontierLevel3PreviewTests(unittest.TestCase):
    ...
    def test_resolved_gate_prefix(self):
        self.assertEqual(
            ...
            [13, 17, 19, 23, 29, 31, 37, 43, 53, 59, 67, 73, 79, 103, 109, 131, 137, 139, 149, 163, 199],
        )
    ...
    def test_hard_unresolved_vs_unworked(self):
        ...
        self.assertEqual(self.report["next_unworked_gate"], 227)
        self.assertEqual(self.report["unworked_preview_gates"][0], 227)
