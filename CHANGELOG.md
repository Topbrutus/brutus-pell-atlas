...
- Expands regression coverage to 74 automated tests.
...
- Records a congruence-filtered scan through k = 5,000,000 with 200,010 admissible prime candidates tested and zero hits.
